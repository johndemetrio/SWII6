...
namespace TP02.Controllers
{
    public class ContainersController : Controller
    {
        ...
        public ContainersController(TP02DbContext context)
        {
            _context = context;
        }
        ...
        {
            var tP02DbContext = _context.Containers.Include(c => c.Bill);
            return View(await tP02DbContext.ToListAsync());
        }
        ...
        {
            ViewData["BillId"] = new SelectList(_context.BillOfLadings, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Numero,Tipo,Tamanho,BillId")] Container container)
        {
            ...
            ViewData["BillId"] = new SelectList(_context.BillOfLadings, "Id", "Id", container.BillId);
            return View(container);
        }
